...
The command above will install the plugin in the main "dependencies" section of package.json, this is mainly needed if your code uses any of the [Lambda Utils](#lambda-utils) included with the package.
